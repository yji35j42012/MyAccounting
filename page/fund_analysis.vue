	...
	<div class="fund">
		...
		<section class="fund_hero normal_shadow">
			...
			<aside class="fund_hero_meta fund_hero_contribution_card">
				...
				<button type="button" class="fund_full_refresh_button" :disabled="activeFullRefresh.isRefreshing"
...
<script>
const FUND_ANALYSIS_VERSION = 'fund-analysis-v1.5.32-2026.08.20';
