			...
			<section class="fund_holdings normal_shadow">
					<div class="fund_section_head">
						...
						<div class="fund_holdings_controls">
							...
							<button type="button" class="fund_holdings_cache_clear_button" @click="clearActiveFundHoldingsCache" aria-label="一鍵清除持股快取">一鍵清除持股快取</button>
						</div>
...
<script>
const FUND_ANALYSIS_VERSION = 'fund-analysis-v1.5.27-2026.08.19';
