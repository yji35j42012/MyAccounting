		...
		<section class="fund_holdings normal_shadow">
			<div class="fund_section_head">
				...
				<div class="fund_holdings_signal" aria-live="polite">
					<div><span>公開前十大持股加權漲跌</span><small>依已取得 Yahoo 報價的公開持股權重計算</small><small>{{ holdingsSignalStatus }}</small></div>
			...
			return {
				...
				taiwanTechnology: { quoteUpdatedAt: '2026 / 08 / 12 14:42', isRefreshing: false, quoteError: '' },
					...
					holdingsSignalsByFund: {
						taiwanTechnology: { weightedChangePct: null, totalWeight: 0, quotedCount: 0, holdingsCount: 10, quoteUpdatedAt: '', savedAt: 0, cacheMode: '' },
						taiwanDaba: { weightedChangePct: null, totalWeight: 0, quotedCount: 0, holdingsCount: 10, quoteUpdatedAt: '', savedAt: 0, cacheMode: '' },
						taiwanIntelligence: { weightedChangePct: null, totalWeight: 0, quotedCount: 0, holdingsCount: 10, quoteUpdatedAt: '', savedAt: 0, cacheMode: '' },
						fuhwaOmni: { weightedChangePct: null, totalWeight: 0, quotedCount: 0, holdingsCount: 10, quoteUpdatedAt: '', savedAt: 0, cacheMode: '' }
					},
				funds: [
				{
